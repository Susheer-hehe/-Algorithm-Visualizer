  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] text-white flex flex-col">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-amber-600/10 rounded-full blur-3xl animate-pulse-slow" />
        <div className="absolute top-1/3 -right-20 w-80 h-80 bg-orange-600/10 rounded-full blur-3xl animate-pulse-slow animation-delay-2000" />
        <div className="absolute -bottom-20 left-1/3 w-72 h-72 bg-yellow-600/8 rounded-full blur-3xl animate-pulse-slow animation-delay-4000" />
      </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center px-4 md:px-8 pb-8 gap-6 max-w-7xl mx-auto w-full">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }} className="w-full max-w-2xl">
          <InsertionStepInfo step={currentStepData} />
        </motion.div>
